...
TELEGRAM_TOKEN = os.environ["TELEGRAM_BOT_TOKEN"]       # GitHub Actions Secret
TELEGRAM_CHAT_ID = os.environ["TELEGRAM_CHAT_ID"]       # GitHub Actions Secret
...
# --- Simula giorno: ogni run avanza di +1 giorno lavorativo
...
# Trova la data simulata:
data_oggi = d_start
giorni_avanzati = 0
while giorni_avanzati < n-1:
    data_oggi += timedelta(days=1)
...
delta_days = giorni_lavorativi_da_a(d_start, data_oggi)
...
# --- Componi messaggio
data_it = data_oggi.strftime("%d/%m/%Y")
